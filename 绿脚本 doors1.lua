...
InfoTab:CreateParagraph({Title = "如何联系作者", Content = "QQ2099718854"})
...
timerTab:CreateButton({
    ...
    Callback = function ()
        ...
        local entity = Creator.createEntity({
            ...
            CustomDialog = {"你死于rush...", "绿", "哈哈哈哈哈哈哈哈"}, -- Custom death message
        })
...
local entity = Creator.createEntity({
    ...
    CustomDialog = {"你死于 A-60", "绿", "我想不到guiding light写啥了.."}, -- Custom death message
})
...
local entity = Creator.createEntity({
    ...
    CustomDialog = {"？", "这是啥玩意", "我也不知道", "反正作者是绿"}, -- Custom death message
})
